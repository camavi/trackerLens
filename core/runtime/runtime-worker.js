...
const RUNTIME_WORKER_VERSION = "0.1.101-multilang-2";
const ports = new Set();
...
const loadRuntimeScripts = () => {
  ...
  importScripts(
    ...
    "channel-registry.js",
    "event-log-store.js",
    "event-bus.js?v=kg-20260626-multilang-2",
    ...
    "action-runtime.js",
    "storage-runtime.js",
    "knowledge-runtime.js?v=kg-20260626-multilang-2",
    "ai-agent-runtime.js?v=kg-20260626-multilang-2",
