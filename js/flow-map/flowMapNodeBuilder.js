...
const nodePalette = [
  ...
  ["Knowledge", [
    ...
    paletteNode({ label: "Graph Query", icon: "manage_search", tone: "cyan", nodeType: "knowledge", subtype: "graph-query", category: "knowledge", inputs: ["knowledge.graph.query", "knowledge.graph.updated"], outputs: ["knowledge.graph.context"], permissions: ["indexeddb.read"], settingsSchema: { query: "string", depth: "number", topK: "number", maxRelations: "number", maxEvidence: "number", maxContextChars: "number", relationTypes: "string", includeEvidence: "boolean", preferLatestDocument: "boolean", collectionId: "string", documentId: "string", outputChannel: "string" }, runtime: { localFirst: true, retrieval: "graph-neighborhood" }, connectionType: "Knowledge: Graph Query" }),
    paletteNode({ label: "Entity Extractor", icon: "account_tree", tone: "green", nodeType: "knowledge", subtype: "entity-extractor", category: "knowledge", inputs: ["knowledge.chunk.created"], outputs: ["knowledge.entity.created", "knowledge.relation.created"], permissions: ["indexeddb.write"], settingsSchema: { extractionMode: "strict|balanced|wide", allowDocumentInput: "boolean", entityTypes: "array", seedTerms: "string", stopWords: "string", confidenceThreshold: "number", maxEntities: "number", maxRelations: "number", relationType: "string", collectionId: "string", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_entities", relationStore: "tl_knowledge_relations" }, connectionType: "Knowledge: Entity Extractor" }),
