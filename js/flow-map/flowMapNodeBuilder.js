...
const nodePalette = [
  ...
  ["Knowledge", [
    ...
    paletteNode({ label: "Embedding Generator", icon: "scatter_plot", tone: "green", nodeType: "knowledge", subtype: "embedding-generator", category: "knowledge", inputs: ["knowledge.chunk.created"], outputs: ["knowledge.embedding.created"], permissions: ["indexeddb.write", "ai.provider"], settingsSchema: { embeddingRuntime: { type: "select", label: "Embedding engine", options: [{ value: "local-hash", label: "Local hash — fast, no AI model" }, { value: "python-local", label: "Local NLP — Sentence Transformers" }, { value: "provider", label: "Configured AI provider" }], defaultValue: "local-hash", description: "Choose how this node turns text into vectors." }, providerProfile: "string", providerType: "string", model: "string", dimensions: "number", collectionId: "string", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_embeddings", algorithm: "local-hash-cosine" }, execution: { runtime: "javascript", capabilities: ["text.embedding"], dependencies: { python: { environment: "nlp", requirements: [{ name: "sentence-transformers", version: "==5.5.0" }], lockfile: "runtimes/python/packs/nlp/requirements.lock", installPolicy: "managed-optional" } } }, connectionType: "Knowledge: Embeddings" }),
