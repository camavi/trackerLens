...
const nodePalette = [
  ...
  ["Knowledge", [
    ...
    paletteNode({ label: "Knowledge Graph", icon: "hub", tone: "cyan", nodeType: "knowledge", subtype: "knowledge-graph", category: "knowledge", inputs: ["knowledge.entity.created", "knowledge.relation.created"], outputs: ["knowledge.graph.updated"], permissions: ["indexeddb.read"], settingsSchema: { graphScope: "workspace|document|collection", autoClearGraph: "boolean", outputChannel: "string" }, runtime: { localFirst: true, phase: "graph-base" }, connectionType: "Knowledge: Graph" }),
    ...
    paletteNode({ label: "Knowledge Graph Builder Agent", icon: "auto_awesome", tone: "gold", nodeType: "knowledge", subtype: "knowledge-graph-builder-agent", category: "knowledge", inputs: ["knowledge.chunk.created", "knowledge.entity.created", "knowledge.relation.created", "knowledge.graph.updated"], outputs: ["knowledge.graph.proposed", "knowledge.semantic.relations", "knowledge.graph.enriched", "knowledge.graph.context"], permissions: ["indexeddb.read", "indexeddb.write", "ai.provider"], settingsSchema: { providerProfile: "string", providerType: "string", model: "string", temperature: "number", maxTokens: "number", topP: "number", streaming: "boolean", responseFormat: "json|structured|text|markdown", systemPrompt: "string", promptTemplate: "string", outputInstructions: "string", maxChunks: "number", maxChunkTokens: "number", maxEntities: "number", maxRelations: "number", confidenceThreshold: "number", relationTypes: "string", technicalNormalization: "boolean", replaceExisting: "boolean", domainHint: "string", collectionId: "string", documentId: "string", outputChannel: "string" }, runtime: { localFirst: true, aiGraphBuilder: true, evidenceRequired: true, store: "tl_knowledge_relations" }, connectionType: "Knowledge: Graph Builder Agent" }),
