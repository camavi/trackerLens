...
const nodePalette = [
  ...
  ["Knowledge", [
    ...
    paletteNode({ label: "Knowledge Dictionary Builder", icon: "travel_explore", tone: "cyan", nodeType: "knowledge", subtype: "knowledge-dictionary-builder", category: "knowledge", inputs: ["knowledge.chunk.created", "knowledge.document.created"], outputs: ["knowledge.dictionary.updated", "knowledge.lexicon.context"], permissions: ["indexeddb.read", "indexeddb.write"], settingsSchema: { scope: "document|collection|workspace", language: "string", maxTerms: "number", minFrequency: "number", collectionId: "string", documentId: "string", replaceExisting: "boolean", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_dictionary", phase: "lexicon" }, connectionType: "Knowledge: Dictionary Builder" }),
    paletteNode({ label: "Knowledge Event Builder", icon: "timeline", tone: "cyan", nodeType: "knowledge", subtype: "knowledge-event-builder", category: "knowledge", inputs: ["knowledge.chunk.created", "knowledge.dictionary.updated", "knowledge.lexicon.context"], outputs: ["knowledge.events.updated", "knowledge.event.context"], permissions: ["indexeddb.read", "indexeddb.write", "ai.provider"], settingsSchema: { extractionMode: "rules|ai|hybrid", providerProfile: "string", providerType: "string", model: "string", temperature: "number", maxTokens: "number", topP: "number", streaming: "boolean", responseFormat: "json|structured|text|markdown", systemPrompt: "string", promptTemplate: "string", outputInstructions: "string", maxEvents: "number", confidenceThreshold: "number", previewEvents: "number", previewIds: "number", collectionId: "string", documentId: "string", replaceExisting: "boolean", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_events", phase: "events", evidenceRequired: true }, connectionType: "Knowledge: Event Builder" }),
    ...
    paletteNode({ label: "Graph Query", icon: "manage_search", tone: "cyan", nodeType: "knowledge", subtype: "graph-query", category: "knowledge", inputs: ["knowledge.graph.query", "knowledge.graph.updated"], outputs: ["knowledge.graph.context"], permissions: ["indexeddb.read"], settingsSchema: { query: "string", depth: "number", topK: "number", maxRelations: "number", maxEvidence: "number", evidenceMode: "focused|balanced|full_ordered|debug_trace", includeAdjacentChunks: "boolean", preserveDocumentOrder: "boolean", protectedEvidence: "boolean", maxContextChars: "number", relationTypes: "string", includeEvidence: "boolean", includeIsolated: "boolean", preferLatestDocument: "boolean", graphScope: "workspace|document|collection", collectionId: "string", documentId: "string", outputChannel: "string" }, runtime: { localFirst: true, retrieval: "graph-neighborhood", connectedContext: true }, connectionType: "Knowledge: Graph Query" }),
    paletteNode({ label: "Knowledge Reasoning Composer", icon: "schema", tone: "cyan", nodeType: "knowledge", subtype: "knowledge-reasoning-composer", category: "knowledge", inputs: ["knowledge.graph.context", "knowledge.event.context"], outputs: ["knowledge.reasoning.plan", "knowledge.graph.context"], permissions: ["indexeddb.read"], settingsSchema: { intentMode: "auto|mechanism|definition|timeline|comparison|fact", maxFacts: "number", maxEvents: "number", includeBackground: "boolean", maxContextChars: "number", outputChannel: "string" }, runtime: { localFirst: true, reasoning: "answer-plan", evidenceRequired: true }, connectionType: "Knowledge: Reasoning Composer" }),
    paletteNode({ label: "Entity Extractor", icon: "account_tree", tone: "green", nodeType: "knowledge", subtype: "entity-extractor", category: "knowledge", inputs: ["knowledge.chunk.created", "knowledge.dictionary.updated", "knowledge.lexicon.context"], outputs: ["knowledge.entity.created", "knowledge.relation.created"], permissions: ["indexeddb.write"], settingsSchema: { extractionMode: "strict|balanced|wide", allowDocumentInput: "boolean", useDictionarySeeds: "boolean", minDictionarySeedTier: "core|typed", maxDictionarySeeds: "number", entityTypes: "array", seedTerms: "string", stopWords: "string", confidenceThreshold: "number", maxEntities: "number", maxRelations: "number", relationType: "string", collectionId: "string", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_entities", relationStore: "tl_knowledge_relations", dictionarySeeds: true }, connectionType: "Knowledge: Entity Extractor" }),
