...
const nodePalette = [
  ...
  ["Knowledge", [
    ...
    paletteNode({ label: "Embedding Generator", icon: "scatter_plot", tone: "green", nodeType: "knowledge", subtype: "embedding-generator", category: "knowledge", inputs: ["knowledge.chunk.created"], outputs: ["knowledge.embedding.created"], permissions: ["indexeddb.write", "ai.provider"], settingsSchema: { embeddingRuntime: { type: "select", label: "Embedding engine", options: [{ value: "local-hash", label: "Local hash — fast, no AI model" }, { value: "python-local", label: "Local NLP — Sentence Transformers (development)" }, { value: "provider", label: "Configured AI provider" }], defaultValue: "local-hash", description: "Choose how this node turns text into vectors." }, providerProfile: "string", providerType: "string", model: "string", dimensions: "number", collectionId: "string", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_embeddings", algorithm: "local-hash-cosine" }, execution: { runtime: "javascript", capabilities: ["text.embedding"], dependencies: { python: { environment: "nlp", requirements: [{ name: "sentence-transformers", version: "==5.5.0" }], lockfile: "runtimes/python/packs/nlp/requirements.lock", installPolicy: "managed-optional" } } }, connectionType: "Knowledge: Embeddings" }),
    paletteNode({ label: "RAG Search", icon: "travel_explore", tone: "cyan", nodeType: "knowledge", subtype: "rag-search", category: "knowledge", inputs: ["knowledge.search.query", "knowledge.embedding.created"], outputs: ["knowledge.rag.context"], permissions: ["indexeddb.read"], settingsSchema: { embeddingRuntime: { type: "select", label: "Query embedding engine", options: [{ value: "local-hash", label: "Local hash — match local-hash vectors" }, { value: "python-local", label: "Local NLP — match Sentence Transformers vectors" }, { value: "provider", label: "Configured AI provider" }], defaultValue: "local-hash", description: "Use the same engine used to generate the collection vectors." }, retrievalRuntime: { type: "select", label: "Retrieval engine", options: [{ value: "javascript-legacy", label: "Legacy cosine — compatibility mode" }, { value: "python-hybrid", label: "Hybrid local NLP — semantic + BM25 (development)" }], defaultValue: "python-hybrid", description: "Hybrid local NLP requires the NLP development pack and preserves TL-owned scope and storage." }, semanticWeight: "number", lexicalWeight: "number", query: "string", topK: "number", similarityThreshold: "number", maxContextTokens: "number", includeMetadata: "boolean", collectionId: "string", outputChannel: "string" }, runtime: { localFirst: true, retrieval: "configurable" }, execution: { runtime: "javascript", capabilities: ["knowledge.rag.retrieve"], dependencies: { python: { environment: "nlp", requirements: [{ name: "sentence-transformers", version: "==5.5.0" }, { name: "bm25s", version: "==0.3.11" }], lockfile: "runtimes/python/packs/nlp/requirements.lock", installPolicy: "managed-optional" } } }, connectionType: "Knowledge: RAG Search" }),
    paletteNode({ label: "Vector Memory", icon: "memory", tone: "green", nodeType: "knowledge", subtype: "vector-memory", category: "knowledge", inputs: ["knowledge.chunk.created"], outputs: ["knowledge.embedding.created"], permissions: ["indexeddb.write", "ai.provider"], settingsSchema: { embeddingRuntime: { type: "select", label: "Embedding engine", options: [{ value: "local-hash", label: "Local hash — fast, no AI model" }, { value: "python-local", label: "Local NLP — Sentence Transformers (development)" }, { value: "provider", label: "Configured AI provider" }], defaultValue: "local-hash", description: "Choose how this node turns text into vectors." }, providerProfile: "string", providerType: "string", model: "string", dimensions: "number", outputChannel: "string" }, runtime: { localFirst: true, store: "tl_knowledge_embeddings" }, execution: { runtime: "javascript", capabilities: ["text.embedding"], dependencies: { python: { environment: "nlp", requirements: [{ name: "sentence-transformers", version: "==5.5.0" }], lockfile: "runtimes/python/packs/nlp/requirements.lock", installPolicy: "managed-optional" } } }, connectionType: "Knowledge: Vector Memory" }),
